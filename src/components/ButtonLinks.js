const ButtonLinks = (props) => {
  return (
    ...
    {props.data.liveSite? 
      <button className="bg-green-300 transform hover:scale-110 text-gray-800 font-bold py-2 px-10 mr-4 rounded"
    ...
    {props.data.repo.frontEnd && !props.data.repo.backEnd?
      <button className="bg-gray-300 transform hover:scale-110 hover:bg-gray-400 text-gray-800 font-bold py-2 px-10 mr-4 rounded"
